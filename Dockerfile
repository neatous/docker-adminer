...
RUN	cd /tmp  && \
	wget https://packages.microsoft.com/debian/11/prod/pool/main/m/msodbcsql18/msodbcsql18_18.1.1.1-1_amd64.deb && \
	dpkg -i msodbcsql18_18.1.1.1-1_amd64.deb && \
	rm -f msodbcsql18_18.1.1.1-1_amd64.deb
